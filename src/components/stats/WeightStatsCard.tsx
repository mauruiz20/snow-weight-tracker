    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-700/50">
          ...
          <p className="mt-1 text-2xl font-bold text-gray-900 dark:text-white">{totalRecords}</p>
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-700">
          <p className="text-sm text-gray-500 dark:text-gray-400">Rango de Peso</p>
          <p className="mt-1 text-lg font-semibold text-gray-900 dark:text-white">
            {minWeight && maxWeight ? `${minWeight.toFixed(1)} - ${maxWeight.toFixed(1)} kg` : '-'}
          </p>
        </div>
      </div>
    </div>
