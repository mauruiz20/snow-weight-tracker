...
export default function Dashboard() {
  const { rankings, loading, error } = useParticipants({ includeRankings: true })
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="animate-fade-in-up mb-8 pt-8 text-center sm:pt-0">
          ...
          <p className="mx-auto mt-2 max-w-2xl text-sm text-gray-500 sm:text-base dark:text-gray-400">
            La meta es hacer snowboard la mayor cantidad de días posibles y pasarla bien entre amigos.
            ¡Ponte en forma para disfrutar al máximo las montañas! 🏂
          </p>
          ...
          <div className="mt-6">
            ...
            <div className="flex justify-center gap-2 sm:gap-4">
              ...
              <div className="rounded-lg bg-linear-to-br from-purple-500 to-purple-600 px-3 py-2 text-white shadow-lg sm:px-4 sm:py-3">
                ...
                <div className="text-xs uppercase tracking-wide opacity-80">Seg</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          ...
          <div className="animate-fade-in-up stagger-5 card-hover rounded-lg border border-gray-200/50 bg-white/80 p-6 backdrop-blur-sm dark:border-gray-700/50 dark:bg-gray-800/80">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Estar en la mejor forma posible para disfrutar el snowboard en Chile.
              Más días en la montaña, menos cansancio, ¡más diversión con los amigos!
            </p>
          </div>
